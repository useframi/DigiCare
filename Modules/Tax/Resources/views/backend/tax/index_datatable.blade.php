        ...
        <x-backend.section-header>
            ...
            <div class="d-flex flex-wrap gap-3">
                ...
                <div>
                    ...
                    <i class="ph ph-upload-simple me-1"></i> {{ __('messages.export') }}
                    </button>
            ...
            <x-slot name="toolbar">
                ...
                <div class="input-group flex-nowrap">
                  ...
                  @hasPermission('add_tax')
                      <button type="button" class="btn btn-primary" data-crud-id="{{ 0 }}" title="{{ __('messages.create') }}  {{ __($module_title) }}"><i class="fas fa-plus-circle me-2"></i>{{ __('messages.new') }}</button>
                  @endhasPermission
              </x-slot>
            </x-backend.section-header>
