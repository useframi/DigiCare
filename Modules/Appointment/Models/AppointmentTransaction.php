...
class AppointmentTransaction extends BaseModel
{
    ...
    protected $fillable = ['appointment_id', 'external_transaction_id', 'transaction_type', 'discount_type','discount_value','discount_amount','discount_amount', 'tip_amount', 'tax_percentage', 'payment_status','total_amount'];
