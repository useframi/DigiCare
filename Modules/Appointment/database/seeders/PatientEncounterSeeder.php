...
class PatientEncounterSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($data as $encounter) {
            ...
            if (optional($appointment->appointmentdetail)->status === "checkout" && optional(optional($appointment->appointmentdetail)->appointmenttransaction)->payment_status === 1) {
                $billing = [
