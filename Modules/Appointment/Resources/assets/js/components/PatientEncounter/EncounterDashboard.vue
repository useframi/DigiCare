                ...
                <ul class="list-inline m-0 p-0">
                  ...
                  <li class="item mb-1">
                    <div class="d-flex align-items-center flex-wrap gap-1">
                      ...
                      <span>{{ moment(EncounterDetails.encounter_date).format('MMMM DD, YYYY') }} </span>
                    </div>
                  </li>
                  <li class="item">
                    <div class="d-flex align-items-center flex-wrap gap-1">
              ...
              <div class="d-flex justify-content-between flex-wrap gap-3 card-header mb-4">
                ...
                <div>
                  <div class="d-flex flex-wrap gap-3">
                    <button class="btn btn-primary" v-if="EncounterDetails.status == 1" data-bs-dismiss="offcanvas" @click.prevent="opensoap()" aria-label="Close">
                      {{ $t('appointment.soap') }}
                    </button>
...
import { DOWNLOAD_INVOICE, ENCOUNTER_DETAIL, GET_SEARCH_DATA, SAVE_OPTION_DATA, REMOVE_DATA, DELETE_PRESCRIPTION_URL, SAVE_OTHER_DETAIL_DATA, DELETE_MEDICAL_REPORT_URL, SEND_PRESCRIPTION_URL, EXPORT_PRESCRIPTION_URL, TEMPLATE_LIST, TEMPLATE_DETAIL, SAVE_ENCOUNTER_DETAILS } from '../../constant/encounter_dashboard'
