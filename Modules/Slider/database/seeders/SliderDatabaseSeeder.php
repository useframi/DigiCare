    ...
    public function run()
    {
        ...
        $sliders = [
            [
                ...
                'type' => 'category',
                'link_id' => 1,
                'file_url' => public_path('/dummy-images/sliders/Offer.jpg'),
            ],
            [
                'name' => 'Banner2',
                'type' => 'category',
                'link_id' => 1,
                'file_url' => public_path('/dummy-images/sliders/Offer1.jpg'),
            ],
            [
                'name' => 'Banner3',
                'type' => 'category',
                'link_id' => 1,
                'file_url' => public_path('/dummy-images/sliders/Offer2.jpg'),
            ],
            [
                'name' => 'Banner4',
                'type' => 'category',
                'link_id' => 4,
                'file_url' => public_path('/dummy-images/sliders/Offer3.jpg'),
            ],
        ];
