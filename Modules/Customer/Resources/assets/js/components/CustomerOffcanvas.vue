        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <flat-pickr placeholder="Select Date Of Birth" id="date_of_birth" :is-required="true" class="form-control" v-model="date_of_birth" :value="date_of_birth" :config="config"></flat-pickr>
