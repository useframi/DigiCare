...
return [
    ...
    'MODULES' => [
        ...
        [
            'module_name' => 'Setting',
            'more_permission' => ['bussiness', 'misc', 'quick_booking','other_setting', 'custom_code', 'customization', 'mail', 'notification', 'intigrations', 'custom_fields', 'currency', 'commission', 'holiday', 'doctor_holiday', 'payment_method', 'language', 'menu_builder', 'invoice','body_chart', 'telemed_service','module'],
            'is_custom_permission' => 0,
        ],
        [
