                ...
                <div class="col-sm-6 col-lg-2">
                    <div class="card dashboard-cards appointments"
                        ...
                        <div class="card-body">
                            ...
                            <h3 class="mb-2">{{ $data['total_user'] }}</h3>
                            <p class="mb-0">{{ __('dashboard.lbl_clinicservice') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <p class="mb-0">
                                                {{ date('M d | H:II', strtotime($booking->start_date_time)) }} |
                                                {{ $booking->serviceProvider->name }}</p>
                                        </div>
                                    </div>
