...
<div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <a href="{{ route('backend.clinics.index') }}" class="text-secondary">
                            <div class="card dashboard-cards appointments">
                                <div class="card-body">
                                    <p class="mb-0">{{__('dashboard.total_number_of')}} {{__('sidebar.location')}} </p>
    ...
    <div class="col-xxl-4 col-lg-5 col-md-6">
        <div class="card card-block card-stretch card-height">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
                ...
                <a href="{{ route('backend.appointments.index') }}" class="text-secondary">View All</a>
                @endif
            </div>
            <div class="card-body pt-0">
    ...
    <div class="col-xxl-4 col-lg-5 col-md-6">
        <div class="card card-block card-stretch card-height">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
                <h4 class="card-title mb-0">Top 10 Location</h4>
                @if(count($data['top_location']) >= 4)
                <a href="{{ route('backend.clinics.index') }}" class="text-secondary" contenteditable="false" style="cursor: pointer;">View All</a>
                @endif
            </div>
            <div class="card-body pt-0">
    ...
    <div class="col-xxl-8 col-lg-7 col-md-6">
        <div class="card card-block card-stretch card-height">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
                ...
                <a href="{{ route('backend.appointments.index') }}" class="text-secondary" contenteditable="false" style="cursor: pointer;">View All</a>
                @endif
            </div>
            <div class="card-body pt-0">
                <div class="table-responsive rounded">
                    <table class="table table-lg m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ date($data['dateformate'], strtotime($paymenthistory->start_date_time)) }} At {{ date($data['timeformate'], strtotime($paymenthistory->start_date_time)) }}</td>
