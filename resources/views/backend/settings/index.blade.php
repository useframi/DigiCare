...
<input type="hidden" name="logo" value="{{asset('img/logo/logo.webp')}}">
<input type="hidden" name="mini-logo" value="{{asset('img/logo/mini_logo.webp')}}">
<input type="hidden" name="dark-logo" value="{{asset('img/logo/dark_logo.webp')}}">
<input type="hidden" name="dark-mini-logo" value="{{asset('img/logo/dark_mini_logo.webp')}}">
<input type="hidden" name="favicon" value="{{asset('img/logo/mini_logo.webp')}}">
