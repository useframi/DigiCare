                        ...
                        <tr class="{{$row_class}}">
                            <td>
                                ...
                                @if($module_name_singular->data['data']['notification_group'] == 'appointment')
                                   <a href="{{ route('backend.appointments.clinicAppointmentDetail', ['id' => $module_name_singular->data['data']['id'], 'notification_id' => $module_name_singular->id]) }}">#{{ $module_name_singular->data['data']['id'] }}</a>
                                @elseif($module_name_singular->data['data']['notification_group'] == 'requestservice')

                                  <a href="{{ route('backend.requestservices.index') }}">#{{ $module_name_singular->data['data']['id'] }}</a>
