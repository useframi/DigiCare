...
<div class="row">
    <div class="col-md-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="mb-0">{{ __('dashboard.lbl_title_clinic_overview') }}</h3>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="card dashboard-cards appointments">
                    <div class="card-body">
                        <p class="mb-0">{{__('appointment.appointment_title')}} </p>
                        <div class="d-flex align-items-center justify-content-between gap-3 mt-5">
                            <h2 class="mb-0" id="totalAppointments">{{ $totalAppointments }}</h2>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card dashboard-cards appointments">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mt-5">
                            <h2 class="mb-0" id="totalDoctorCommission">{{ \Currency::format($totalDoctorCommission) }}</h2>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card dashboard-cards appointments">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mt-5">
                            <h2 class="mb-0" id="totalAdminCommission">{{ \Currency::format($totalAdminCommission) }}</h2>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card dashboard-cards appointments">
                    <div class="card-body">
                        <p class="mb-0">{{__('dashboard.total_number_of')}} {{__('appointment.lbl_clinic')}}</p>
                        <div class="d-flex align-items-center justify-content-between gap-3 mt-5">
                            <h2 class="mb-0" id="total_clinics">{{ $total_clinics }}</h2>
                            <img src="{{ asset('img/dashboard/active-vendor.png') }}" alt="image">
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card dashboard-cards appointments">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mt-5">
                        @if(multiVendor() == 1)
                            <h2 class="mb-0" id="totalClinicRevenue">{{ \Currency::format($totalClinicRevenue) }}</h2>
                          @else
                          <h2 class="mb-0" id="totalClinicRevenue"> {{ \Currency::format($totalAdminCommission) }}</h2>
...
<script type="text/javascript" defer>
    ...
    const columns = [{
        ...
        @if(multiVendor() == 1)
        {
            data: 'clinic_admin',
            name: 'clinic_admin',
            title: "{{ __('report.lbl_clinic_admin') }}",
            width: '10%',
        },
        @endif
        {
        ...
        },
        {
            data: 'no_booking',
            name: 'no_booking',
            title: "{{ __('report.lbl_total_appointments') }}",
        ...
        @if(multiVendor() == 0)
        {
            data: 'admin_pay',
            name: 'clinic_pay',
            title: "{{ __('report.lbl_clinic_pay') }}",
        ...
        },
        {
            data: 'total_income',
            name: 'total_income',
            title: "{{ __('report.lbl_total_income') }}",
    ...
    function filterByDateRange(dateRange) {
        ...
        $.ajax({
            url: '{{ route('backend.reports.clinic-overview.date_range') }}',
            type: 'GET',
            data: {
            ...
            success: function(response) {
                ...
                $('#totalAppointments').text(response.data.total_appointments);
                $('#totalDoctorCommission').text(response.data.total_doctor_commission);
                $('#totalAdminCommission').text(response.data.total_admin_commission);
                $('#totalClinicRevenue').text(response.data.total_clinic_revenue);
                $('#total_clinics').text(response.data.total_clinics);
            },
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        initDatatable({
            url: '{{ route('backend.reports.clinic-overview.index_data') }}',
            finalColumns,
            orderColumn: [[ 1, 'desc' ]],
